...
const DoctorCard = ({ doctor }) => {
    const { name, avgRating, totalRating, totalPatients, specialization, experiences, photo } = doctor;
    return (
        <div className='p-3 lg:p-5'>
            ...
            <div className="mt-2 lg:mt-4 flex items-center justify-between">
                <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] rounded lg:leading-7 font-semibold'>{specialization}</span>
