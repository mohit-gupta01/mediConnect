            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className='text__para'>
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nisi tenetur veritatis fugiat. Sunt enim dolore maxime deserunt dolor libero aliquam ducimus optio? Aliquam assumenda magni iste illum itaque omnis voluptas?
                </p>
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className='text__para text-center'>World-class care for everyone. Our health system offers unmatched health services.</p>
          </div>
          <ServiceList />
        </div>
      </section>
        ...
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            <div className="xl:w-[670px]">
              ...
              <ul className='pl-4'>
                <li className='text__para'>1. Schedule the appointent directly.</li>
